...
public class UserDAO {
	...
	public List<User> findAll(){
		...
		TypedQuery<User> query = em.createNamedQuery("find all", User.class);
	...
	public User finUserByUsername(String username){
		EntityManager em = dbConnection.getEntityManager();
		TypedQuery<User> query = em.createNamedQuery("find by username", User.class);
	...
	public List<User> findUserByName(String name){
		EntityManager em = dbConnection.getEntityManager();
		TypedQuery<User> query = em.createNamedQuery("find by name", User.class);
	...
	public List<User> findUserByNameAndCompany(String nameOrCompany){
		EntityManager em = dbConnection.getEntityManager();
		Query query = em.createNamedQuery("find by name or company");
	...
	public User findUserById(int id){
		EntityManager em = dbConnection.getEntityManager();
		TypedQuery<User> query = em.createNamedQuery("find by id", User.class);
